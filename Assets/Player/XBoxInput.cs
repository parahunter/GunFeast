...
class XBoxInput : MonoBehaviour
{
	...
	static public float GetRightTrigger(int player)
	{
		return Input.GetAxis("joystick " + player + " right trigger");
	}
		
	static public float GetLeftTrigger(int player)
	{
		return Input.GetAxis("joystick " + player + " left trigger");
	}
